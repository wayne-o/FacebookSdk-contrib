...
namespace Facebook.Api
{
    ...
    /// <summary>
    /// Formats a query expression into FQL language syntax
    /// </summary>
    public class FqlFormatter : SqlFormatter
    {
        protected FqlFormatter(QueryLanguage language)
            : base(language)
        {
        }
        ...
        {
            return Format(expression, new FqlLanguage());
        }

        public static string Format(Expression expression, QueryLanguage language)
        {
            FqlFormatter formatter = new FqlFormatter(language);
